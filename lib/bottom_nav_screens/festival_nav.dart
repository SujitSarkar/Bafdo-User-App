      ...
      children: [
        ...
        Container(
          child: Padding(
            ...
            child: Text(
              'বাঙালি উৎসব প্রিয় জাতি। উৎসবে যেন বাঙালির নতুন প্রাণ। এই প্রাণের সঞ্চারণ ঘটে উৎসবের ভিন্ন ভিন্ন প্রতিটি জিনিসে।  এক একটি প্রাণ মিলে যেন এক প্রাণের মেলার সৃষ্টি হয়। এইযে ইন্টারনেট দুনিয়ার বাহিরে বাঙালির যে আত্মটান সেটাকেই ডিজিটালাইশনের মাধ্যমে বর্তমান সময়োপযোগী করে সবার কাছে তুলে ধরার জন্য আমাদের এই ফিচারটি। এখানে, বিভিন্ন উৎসবকে কেন্দ্র করে নির্দিষ্ট সময়ানুযায়ী এক একটি ফেস্টিভালের কার্যক্রম থাকবে।',
