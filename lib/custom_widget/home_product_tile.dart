...
class HomeProductListTile extends StatefulWidget {
  final HomeProductData? productList;

  HomeProductListTile({this.productList});

  @override
  _HomeProductListTileState createState() =>
      _HomeProductListTileState();
}

class _HomeProductListTileState extends State<HomeProductListTile> {
  bool favorite = false;
  int _counter=0;
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        widget.productList!.basePrice!.toString().replaceAll('৳', '').replaceAll('.00', ''),
                        style: TextStyle(
                            fontFamily: 'taviraj',
                            color: Colors.grey,
                            fontWeight: FontWeight.bold,
